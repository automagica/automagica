...
<img src="https://cdn.jsdelivr.net/npm/line-awesome@1.3.0/svg/digital_tachograph-solid.svg" width="20"> [Random data](https://automagica.readthedocs.io/activities.html#automagica.activities.generate_random_data) | Generates all kinds of random data. Specifying locale changes format for some options
