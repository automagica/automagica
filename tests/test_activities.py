...
def test_copy_folder():
    ...
    assert (
        type(copied_folder) is str
        and "copied" in copied_folder
        and testfolder in copied_folder
    )
...
def test_zip_folder():
    ...
    assert (
        type(zipped_folder) is str
        and testfolder in zipped_folder
        and "zipped" in zipped_folder
    )
