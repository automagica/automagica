...
def recorder():
    ...
    text = sg.Text(
        "Please select an action to perform with Automagica Vision",
        background_color="#2196F3",
        text_color="white",
    )
    ...
    text = sg.Text(
        "Please select the area of the element on the screen",
        background_color="#2196F3",
        text_color="white",
    )
    ...
    if result.get("element_id"):
        ...
        if action == "Click":
            insert_cell_below(
                "<img src='data:image/jpeg;base64, {}'>".format(preview_base64),
                type_="markdown",
            )
            insert_cell_below(
                "click_vision('{}')".format(result["element_id"]), type_="code"
            )
        ...
        if action == "Double Click":
            ...
            insert_cell_below(
                "double_click_vision('{}')".format(result["element_id"]), type_="code"
            )
        ...
        if action == "Right Click":
            ...
            insert_cell_below(
                "right_click_vision('{}')".format(result["element_id"]), type_="code"
            )
        ...
        if action == "Read Text":
            ...
            insert_cell_below(
                "read_vision('{}')".format(result["element_id"]), type_="code"
            )
        ...
        if action == "Wait Appear":
            ...
            insert_cell_below(
                "wait_appear_vision('{}')".format(result["element_id"]), type_="code"
            )
        ...
        if action == "Wait Disappear":
            ...
            insert_cell_below(
                "wait_disappear_vision('{}')".format(result["element_id"]), type_="code"
            )
